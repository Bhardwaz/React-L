const headingg = React.createElement('h1', {}, "Namaste React 🚀")
const roott = ReactDOM.createRoot(document.getElementById('root'))

// nested elements using create element

const nested = React.createElement('div', {}, React.createElement(
    'p', {}, "Namasate React inside paragraph tag 🚀"
))
root.render(nested)
